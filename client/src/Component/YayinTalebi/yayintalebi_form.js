...
const Yayintalebi_form = (props) => {
  ...
  const [yayinSuresi, setYayinSuresi] = useState(0);
  ...
  useEffect(() => {
    props.Oturum.then((resp) => {
      const GetOrderList = Post("GetUserOrder", {
        UserId: resp.data.data.data._id,
      });
  ...
  const DateChange = async (e) => {
    ...
    var checkDate = await Post("GetDateIsAvaible", {
      Date: moment(e.target.value).format("YYYY-MM-DD HH"),
    });
    if (checkDate.data) {
          ...
          <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
            <div class="iq-card-body">
              <p style={{ fontWeight: "bold", color: "red" }}>
                Lütfen Yayın Talep Tarih ve Saatinizi Bir Gün Önceden
                Belirtiniz..
              </p>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input
                      ...
                      class="form-control"
                      id="exampleInputdatetime"
                      onChange={(e) => setYayinSuresi(parseInt(e.target.value))}
                    />
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="iq-card">
                      <div class="iq-card-body border text-center rounded">
                        <span class="font-size-16 text-uppercase">
                          {SelectProduct.Name}
                        </span>
                        <h2 class="mb-4 display-4 font-weight-bolder ">
                          {parseFloat(SelectProduct.Price).toFixed(2)}{" "}
                          <small class="font-size-14 text-muted">TL</small>
                        </h2>
